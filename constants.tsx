...
export const STROKES = ['Nage Libre', 'Dos', 'Brasse', 'Papillon', '4 Nages'];

export const CATEGORY_ORDER = ["École", "Poussin", "Benjamin", "Minime", "Cadet", "Junior", "Senior"];
export const GENDER_ORDER = ["F", "M", "Mixte"];
...
export const Icons = {
  ...
  Table: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2h-7z"/><path d="M3 9h18"/><path d="M12 21V9"/></svg>
  ),
  Reverse: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m7 21-4-4 4-4"/><path d="M3 17h18"/><path d="m17 3 4 4-4 4"/><path d="M21 7H3"/></svg>
  ),
  Edit: () => (
